          ...
          <div>
            ...
            >
              ...
              <div class="flex flex-col no-print">
                <text-styles type="primary_color extrabold smaller"
                  >This is a prototype done in the shortest amount of time possible. </text-styles
                >
            ...
            >
              ...
              <div class="flex flex-col no-print">
                ...
                >
                <text-styles type="secondary_color bold smallerer"
                  >The latest version (which produced above screenshots) was lost as the project was discontineud.
                </text-styles>
              </div>
            </ui-area>
